        ...
        <div className="flex-1 flex items-center justify-center p-6 bg-slate-950">
            ...
            >
                <div className="text-center mb-8">
                    <h1 className="text-4xl font-black mb-2">Join the <span className="text-primary-500">Arena</span></h1>
                ...
                <div className="glass p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-xs font-black uppercase tracking-widest text-slate-500 ml-1">Identity</label>
                    ...
                    <div className="mt-8 pt-8 border-t border-white/5 text-center">
                        <p className="text-slate-400 text-sm">
                            Already a warrior? <Link to="/login" className="text-primary-400 font-bold hover:underline">Sign In</Link>
                        </p>
                    </div>
                </div>
            </motion.div>
